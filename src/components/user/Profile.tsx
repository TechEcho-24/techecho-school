...
type RankType = "Bronze" | "Rookie" | "Silver" | "Gold" | "Platinum" | "Maxed";

let rank: RankType = "Rookie";
let nextRank: RankType = "Bronze";
...
export const Profile = () => {
  ...
  const handleCropAndUpload = async () => {
    ...
    dispatch(uploadImage(croppedBlob) as any);
      ...
      {showCropModal && (
        <div className='fixed inset-0 bg-black bg-opacity-70 z-[999] flex items-center justify-center'>
          <div className='bg-white p-6 rounded-xl w-[90vw] max-w-md h-[400px] relative'>
            <Cropper
              image={typeof imageSrc === "string" ? imageSrc : undefined}
              crop={crop}
              zoom={zoom}
              aspect={1}
              cropShape='round'
