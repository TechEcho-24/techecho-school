...
export const Hero = () => {
  return (
    <section className='relative pt-32 min-h-[96vh] drop-shadow-lg  w-full flex items-center justify-center px-4 bg-gradient-to-r from-bg to-pink-50 md:py-20 py-4 rounded-xl '>
      <BubblesBackground />
      <div className='relative z-10 md:pl-20 md:pr-10 w-full flex flex-col md:flex-row justify-center items-center gap-12'>
        ...
        {/* Right Section */}
        <div className='relative w-full mb-10 basis-fulls md:basis-1/3 z-10'>
          <IconCloudGlobe />
        </div>
      </div>
    </section>
