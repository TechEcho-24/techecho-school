...
export const CourseCard = ({
  ...
  return (
    <Link to={path}>
      <div
        className={cn(
          "group relative md:w-lg w-[300px] mx-auto flex flex-row items-center gap-4 md:gap-6 p-4 md:p-6 border rounded-2xl transition-all hover:shadow-xl hover:scale-[1.01]",
      ...
      >
        ...
        <div className="w-[45%] md:w-1/3">
          <img
            src={image}
            alt={title}
            className="rounded-xl w-full object-cover h-32 shadow-md"
          />
        </div>
        ...
        <div className="flex-1 space-y-2 text-left">
          ...
          {/* <p className="text-sm text-gray-600">{description.slice(2)}</p> */}
